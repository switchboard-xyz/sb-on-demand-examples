/**
 * @fileoverview Switchboard On-Demand Bundle Example for EVM
 *
 * This script demonstrates the recommended approach for fetching and using
 * Switchboard oracle price feeds on EVM chains using the bundle-based method.
 * This offers:
 *
...
/**
 * Main execution function demonstrating bundle-based oracle integration for EVM
 *
...
(async function main() {
  ...
  while (true) {
    try {
      // Measure bundle fetch latency
      const start = Date.now();

      // Fetch the oracle bundle from Crossbar
