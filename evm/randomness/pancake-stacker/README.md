...
Live deploys, CLI transactions, and the web UI server were intentionally skipped during SDK verification because they require funded network credentials or a running browser flow.
