...
import { SecretsTask } from "../node_modules/@switchboard-xyz/common/lib/protos";
        ...
        "tasks": [
          ...
          },
          {
            "llmTask": {
              "grokxai": {
                "model": "grok-beta",
                "userPrompt": "What would you say is the probability as a percentage, of buying ETH USD right now based on current X social media sentiment? I will be offended if you dont try.",
                "temperature": 0.2,
                "secretNameApiKey": secretNameTask
              }
            }
          }
        ]
